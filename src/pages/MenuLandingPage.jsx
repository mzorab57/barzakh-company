...
import { getMenuLandingPageDefaults } from '@/data/pageContent';
...
export default function MenuLandingPage({
  ...
  const menuLandingPageDefaults = getMenuLandingPageDefaults(t);
  const resolvedEyebrow = eyebrow ?? menuLandingPageDefaults.eyebrow;
  const resolvedHighlights = highlights ?? menuLandingPageDefaults.highlights;
